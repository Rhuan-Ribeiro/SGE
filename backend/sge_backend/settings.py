"""
Django settings for sge_backend project.
...
production_server = 'sge.up.railway.app/'
...
INSTALLED_APPS = [
    ...
    'rest_framework.authtoken', # autenticação via webtoken
    # 'rest_framework_simplejwt', # autenticação via jwt 
    'djoser', # mecanismo de autentição
    'app' # nosso app
]
...
WSGI_APPLICATION = 'sge_backend.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.TokenAuthentication' # webtoken
    ],
}
